        ...
        <a href={'/products/' + product.id}>
            ...
            <div class="px-5 pb-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button class="text-white bg-[#FF4F01] hover:bg-[#FF4F01] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#FF4F01] dark:hover:bg-[#ff0101e7] dark:focus:ring-blue-800"
                        >Add to cart</button>
                </div>
            </div>
        </a>
